                ...
                while True:
                        ...
                        try:
                                ...
                                if(a.lower()=='goodbye' or a.lower()=='good bye' or a.lower()=='bye'):
                                    ...
                                    lbl = ImageLabel(root)
                                    lbl.pack()
                                    lbl.load(r'C:/codes/Automatic-Indian-Sign-Language-Translator-ISL/Automatic-Indian-Sign-Language-Translator-ISL/ISL_Gifs/{0}.gif'.format(a.lower()))
                                    root.mainloop()
                                else:
                                    for i in range(len(a)):
                                                    if(a[i] in arr):
                                            
                                                            ImageAddress = 'C:/codes/Automatic-Indian-Sign-Language-Translator-ISL/Automatic-Indian-Sign-Language-Translator-ISL/letters/'+a[i]+'.jpg'
                        ...
                        plt.close()
while 1:
  image   = "C:\codes\Automatic-Indian-Sign-Language-Translator-ISL\Automatic-Indian-Sign-Language-Translator-ISL\signlang.png"
  msg="HEARING IMPAIRMENT ASSISTANT"
  choices = ["Live Voice","All Done!"] 
  reply   = buttonbox(msg,image=image,choices=choices)
  if reply ==choices[0]:
